...
## Comments
Modified by Leo Weissbart. </br>
The modifications includes a GPIO module to send trigger with the Jetson headers and the project compiles with a **Makefile** instead of using Eclispse Nsight project.</br>
The Makefile is adapted from one of a cuda sample makefile for this project.</br>
Source for the GPIO module: [github.com/jetsonhacks/jetsonTX1GPIO](https://github.com/jetsonhacks/jetsonTX1GPIO)
